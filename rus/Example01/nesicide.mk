...
### Example01 or modify the custom rules
...
# Default: none
LDFLAGS = -t nes -C $(CONFIG)  -Wl --dbgfile,Example01.dbg
REMOVES += Example01.dbg
...
PROGRAM = $(PRGDIR)/Example01.prg

# Set SOURCES to something like 'src/foo.c src/bar.s'.
SOURCES := 
SOURCES += src/main.s src/header.s src/neslib.s
SOURCES += 
