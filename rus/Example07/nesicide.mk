...
### Example07 or modify the custom rules
...
# Default: none
LDFLAGS = -t nes -C $(CONFIG)  -Wl --dbgfile,Example07.dbg
REMOVES += Example07.dbg
...
PROGRAM = $(PRGDIR)/Example07.prg

# Set SOURCES to something like 'src/foo.c src/bar.s'.
SOURCES := 
SOURCES += src/header.s src/main.s src/neslib.s
SOURCES += 
